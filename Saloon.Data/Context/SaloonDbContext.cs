...
public partial class SaloonDbContext : DbContext
{
    ...
    public virtual DbSet<AccessRightTypes> AccessRightTypes { get; set; }
    ...
    public virtual DbSet<CustomersSubscriptions> CustomersSubscriptions { get; set; }

    public virtual DbSet<DeviceTypes> DeviceTypes { get; set; }

    public virtual DbSet<DiscountedProducts> DiscountedProducts { get; set; }

    public virtual DbSet<DiscountedServices> DiscountedServices { get; set; }

    public virtual DbSet<MediaStore> MediaStore { get; set; }

    public virtual DbSet<MediaType> MediaType { get; set; }

    public virtual DbSet<MediaTypesFormats> MediaTypesFormats { get; set; }

    public virtual DbSet<Notifications> Notifications { get; set; }

    public virtual DbSet<NotificationsSubscription> NotificationsSubscription { get; set; }
    ...
    public virtual DbSet<ShopGenderCategory> ShopGenderCategory { get; set; }

    public virtual DbSet<Staff> Staff { get; set; }

    public virtual DbSet<StaffOccupiedTime> StaffOccupiedTime { get; set; }

    public virtual DbSet<StaffSchedule> StaffSchedule { get; set; }

    public virtual DbSet<StaffServices> StaffServices { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer(CommonAppConfig.GetConnectionString("DefaultConnection"), x => x.UseNetTopologySuite());
        }
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AspNetUsers>(entity =>
        {
            ...
            entity.HasOne(d => d.AccessRightType).WithMany(p => p.AspNetUsers)
                .HasForeignKey(d => d.AccessRightTypeId)
                .HasConstraintName("FK_AspNetUsers_AccessRightTypes");

            entity.HasOne(d => d.FkCustomer).WithMany(p => p.AspNetUsers)
                .HasForeignKey(d => d.FkCustomerId)
                .HasConstraintName("FK_AspNetUsers_Customers");

            entity.HasOne(d => d.ImageMediaStore).WithMany(p => p.AspNetUsersImageMediaStore)
                .HasForeignKey(d => d.ImageMediaStoreId)
                .HasConstraintName("FK_AspNetUsers_MediaStore");

            entity.HasOne(d => d.ImageThumbnailMediaStore).WithMany(p => p.AspNetUsersImageThumbnailMediaStore)
                .HasForeignKey(d => d.ImageThumbnailMediaStoreId)
                .HasConstraintName("FK_AspNetUsers_MediaStore1");

            entity.HasOne(d => d.UserType).WithMany(p => p.AspNetUsers)
        ...
        modelBuilder.Entity<ClientBank>(entity =>
        {
            ...
            entity.HasOne(d => d.AspNetUser).WithMany(p => p.ClientBankAspNetUser)
                .HasForeignKey(d => d.AspNetUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ClientBank_AspNetUsers3");

            entity.HasOne(d => d.City).WithMany(p => p.ClientBank)
                .HasForeignKey(d => d.CityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ClientBank_Country");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ClientBankCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ClientBank_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ClientBankDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_ClientBank_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ClientBankModifiedByNavigation)
        ...
        modelBuilder.Entity<ClientServices>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ClientServicesCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ClientServices_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ClientServicesDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_ClientServices_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ClientServicesModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<Customers>(entity =>
        {
            ...
            entity.HasOne(d => d.LastModifiedByNavigation).WithMany(p => p.CustomersLastModifiedByNavigation)
                .HasForeignKey(d => d.LastModifiedBy)
                .HasConstraintName("FK_Customers_AspNetUsers1");

            entity.HasOne(d => d.MediaStore).WithMany(p => p.Customers)
        ...
        modelBuilder.Entity<CustomersSubscriptions>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.CustomersSubscriptionsCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomersSubscriptions_AspNetUsers");

            entity.HasOne(d => d.Customer).WithMany(p => p.CustomersSubscriptions)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK_CustomersSubscriptions_Customers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.CustomersSubscriptionsDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_CustomersSubscriptions_AspNetUsers1");

            entity.HasOne(d => d.LastModifiedByNavigation).WithMany(p => p.CustomersSubscriptionsLastModifiedByNavigation)
                .HasForeignKey(d => d.LastModifiedBy)
        ...
        modelBuilder.Entity<DiscountedProducts>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.DiscountedProductsCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DiscountedProducts_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.DiscountedProductsDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_DiscountedProducts_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.DiscountedProductsModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
                .HasConstraintName("FK_DiscountedProducts_AspNetUsers2");

            entity.HasOne(d => d.Product).WithMany(p => p.DiscountedProducts)
        ...
        modelBuilder.Entity<DiscountedServices>(entity =>
        {
            ...
            entity.HasOne(d => d.ClientServices).WithMany(p => p.DiscountedServices)
                .HasForeignKey(d => d.ClientServicesId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DiscountedServices_ClientServices");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.DiscountedServicesCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DiscountedServices_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.DiscountedServicesDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_DiscountedServices_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.DiscountedServicesModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<MediaStore>(entity =>
        {
            ...
            entity.HasOne(d => d.MediaType).WithMany(p => p.MediaStore)
        ...
        modelBuilder.Entity<MediaTypesFormats>(entity =>
        {
            ...
            entity.HasOne(d => d.MediaTypes).WithMany(p => p.MediaTypesFormats)
        ...
        modelBuilder.Entity<NotificationsSubscription>(entity =>
        {
            ...
            entity.HasOne(d => d.AspNetUsers).WithMany(p => p.NotificationsSubscription)
                .HasForeignKey(d => d.AspNetUsersId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NotificationsSubscription_AspNetUsers");

            entity.HasOne(d => d.Notifications).WithMany(p => p.NotificationsSubscription)
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ProductCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Product_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ProductDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_Product_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ProductModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<Province>(entity =>
        {
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Province)
        ...
        modelBuilder.Entity<Shop>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ShopCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Shop_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ShopDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_Shop_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ShopModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
                .HasConstraintName("FK_Shop_AspNetUsers2");

            entity.HasOne(d => d.ShopCategory).WithMany(p => p.Shop)
                .HasForeignKey(d => d.ShopCategoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Shop_ShopCategory");

            entity.HasOne(d => d.ShopGenderCategory).WithMany(p => p.Shop)
        ...
        modelBuilder.Entity<ShopCategory>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ShopCategoryCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ShopCategory_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ShopCategoryDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_ShopCategory_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ShopCategoryModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<ShopGenderCategory>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.ShopGenderCategoryCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ShopGenderCategory_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.ShopGenderCategoryDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_ShopGenderCategory_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.ShopGenderCategoryModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.StaffCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Staff_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.StaffDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_Staff_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.StaffModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<StaffOccupiedTime>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.StaffOccupiedTimeCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffOccupiedTime_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.StaffOccupiedTimeDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_StaffOccupiedTime_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.StaffOccupiedTimeModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
                .HasConstraintName("FK_StaffOccupiedTime_AspNetUsers2");

            entity.HasOne(d => d.ScheduleDay).WithMany(p => p.StaffOccupiedTime)
                .HasForeignKey(d => d.ScheduleDayId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffOccupiedTime_ScheduleDays");

            entity.HasOne(d => d.Staff).WithMany(p => p.StaffOccupiedTime)
        ...
        modelBuilder.Entity<StaffSchedule>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.StaffScheduleCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffSchedule_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.StaffScheduleDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_StaffSchedule_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.StaffScheduleModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
                .HasConstraintName("FK_StaffSchedule_AspNetUsers2");

            entity.HasOne(d => d.ScheduleDay).WithMany(p => p.StaffSchedule)
                .HasForeignKey(d => d.ScheduleDayId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffSchedule_ScheduleDays");

            entity.HasOne(d => d.Staff).WithMany(p => p.StaffSchedule)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StaffServices>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.StaffServicesCreatedByNavigation)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffServices_AspNetUsers");

            entity.HasOne(d => d.DeletedByNavigation).WithMany(p => p.StaffServicesDeletedByNavigation)
                .HasForeignKey(d => d.DeletedBy)
                .HasConstraintName("FK_StaffServices_AspNetUsers1");

            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.StaffServicesModifiedByNavigation)
                .HasForeignKey(d => d.ModifiedBy)
        ...
        modelBuilder.Entity<UserAccessRights>(entity =>
        {
            ...
            entity.HasOne(d => d.AspNetUser).WithMany(p => p.UserAccessRights)
                .HasForeignKey(d => d.AspNetUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<UserDeviceInformations>(entity =>
        {
            ...
            entity.HasOne(d => d.AppUser).WithMany(p => p.UserDeviceInformations)
                .HasForeignKey(d => d.AppUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserDeviceInformations_AppUsers");

            entity.HasOne(d => d.DeviceType).WithMany(p => p.UserDeviceInformations)
